...
namespace ERP.Pages.RRHH
{
    public class RegistrarEmpleadoModel : PageModel
    {
        ...
        private List<string> distritosCañas;
        private List<string> distritosAbangares;
        private List<string> distritosTilarán;
    ...
    "Acosta", "Tibás", "Moravia", "Montes de Oca", "Turrubares", "Dota", "Curridabat", "Pérez Zeledón", "León Cortés Castro"
            ...
            List<string> distritosPuriscal = new List<string>
        {
            ...
            List<string> distritosTarrazú = new List<string>
        {
            ...
            List<string> distritosCurridabat = new List<string>
        {
            ...
            List<string> distritosPérezZeledon = new List<string>
        {
